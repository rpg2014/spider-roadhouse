...
export const NewEntry: React.FC = () => {
  ...
  const { data, error, isPending, run, isFulfilled } = useFetch<ICreateEntryResponse>(
    SPIDERMAN_BASE_URL + JOURNAL + NEW,
    options
  );
  ...
  const getSubmitButton = () => {
    ...
    return (
      <button className="btn btn-dark btn-outline-light float-right small-font mt-1" onClick={handleSubmit}>
