...
export default class Boids extends React.Component<{}, {}> {
  ...
  constructor(props: any) {
    ...
    // Create boid world.
    this.orch = BoidOrchestrator.new(
      this.worldWidth,
      this.worldHeight,
      this.numBoids,
      this.convergenceValue,
      this.avoidanceValue,
      this.avoidanceRange,
      this.percivedVelValue,
      this.borderVelModifier
    );
  ...
  componentDidMount() {
    ...
    for (let i = 0; i < this.numBoids; i++) {
      ...
      if (this.isDebug) {
        boidContainer.addChild(this.getVelDebugContainer(i, false));
      }
      ...
      <main className="inner col mx-auto">
        <Col>
          ...
          <Row className="justify-content-center">
            <Button variant="outline-dark" className="m-2" onClick={this.tick}>
              tick
            </Button>
            <Button variant="dark" className="m-2" onClick={this.play}>
              play
            </Button>
            <Button variant="dark" className="m-2" onClick={this.pause}>
              pause
            </Button>
            <Button
              variant={this.isDebug ? 'dark' : 'outline-dark'}
              className="m-2"
              onClick={() => {
            ...
            <Button variant="outline-warning" className="m-2" onClick={this.reset}>
              reset
            </Button>
            <Button variant="dark" className="m-2" onClick={this.toggleBG}>
              toggleBG
            </Button>
            {/* <span>
                            Number of Boids:
