...
import {
  ...
  SERVER_START_ACTION,
  SERVER_STOP_ACTION,
  SERVER_STOP_ACTION_SUCCESS,
  SERVER_START_ACTION_SUCCESS,
  SERVER_START_ACTION_FAILED,
  SERVER_STOP_ACTION_FAILED,
...
export function serverActionStatusReducer(
  fetchingState = initalFetchingState,
  action: IAction<IServerActionStatus>
): IFetchingState<IServerActionStatus> {
  switch (action.type) {
