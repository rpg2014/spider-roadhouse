...
import {
  IAction,
  SERVER_DETAILS_ACTION,
  SERVER_DETAILS_ACTION_SUCCESS,
  SERVER_DETAILS_ACTION_FAILED,
...
export function serverDetailsReducer(
  fetchingState = initalFetchingState,
  action: IAction<IServerDetails>
): IFetchingState<IServerDetails> {
  switch (action.type) {
