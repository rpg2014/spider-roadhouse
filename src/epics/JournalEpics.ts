...
export function fetchJournalEntriesEpic(
  action$: ActionsObservable<IAction<JournalEntryProps[]>>,
  store$: StateObservable<IApplicationStore>
): Observable<IAction<JournalEntryProps[]>> {
  return action$.pipe(
...
export function createJournalEntryEpic(
  action$: ActionsObservable<IAction<boolean, Partial<JournalEntryProps>>>,
  store$: StateObservable<IApplicationStore>
): Observable<IAction<boolean, Partial<JournalEntryProps>>> {
  return action$.pipe(
...
export function sendCreateEntryRequest(
  request?: Partial<JournalEntryProps>,
